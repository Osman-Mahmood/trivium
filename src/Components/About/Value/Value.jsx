  ...
  return (
    ...
    <div className='container mt-5'>
      {/* <div className='row'>
        ...
        <p className='text-center'>Medcare’s core values are reflected in our dedication to delivering the most efficient solutions for medical billing and revenue cycle <br /> management.</p>
...
<h5>Expertise</h5>
<p>Our certified medical billing specialists and technical analysts are highly trained and adept in all areas of medical claims billing. Medcare MSO provides comprehensive, continuous training so our team is always up to date on current regulations and technologies.</p>
        </div>
        <div className='col-lg-6 col-12 revenue_box'>
<img src={value} alt="" className='img-fluid value'/>
<h5>Expertise</h5>
...
<p>Our certified medical billing specialists and technical analysts are highly trained and adept in all areas of medical claims billing. Medcare MSO provides comprehensive, continuous training so our team is always up to date on current regulations and technologies.</p>
       ...
       <div className='container'>
          ...
          <p>Medcare offers comprehensive professional billing services and best-practice process management to shorten your reimbursement cycle, increase revenue streams, and maximize profitability.
